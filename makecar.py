...
#Connect to Ganache
def makeCar(_car_info="cheap car cuz we broke",_additional="change its oil"):
	...
	tx_hash = contract.functions.setCar(1,_car_info, _additional,30 ).transact({'from': account})
